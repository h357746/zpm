<template>
  ...
  <el-form-item label="车辆制造商">
    <el-input v-model="formInline.dcno" placeholder="车辆制造商"></el-input>
  </el-form-item>
    <el-form-item label="企业名称">
    <el-input v-model="formInline.companyName" placeholder="企业名称"></el-input>
  </el-form-item>
      <el-form-item label="颜色">
    <el-input v-model="formInline.dctype" placeholder="颜色"></el-input>
  </el-form-item>
      <el-form-item label="产品型号">
    <el-input v-model="formInline.dctype" placeholder="产品型号"></el-input>
  </el-form-item>
